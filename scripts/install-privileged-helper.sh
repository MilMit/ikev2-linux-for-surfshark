...
echo "MilMit Surfshark privileged helper, control center, auth-fixed connector, watchdog, hotspot device manager and GNOME VPN indicator installed."
...
echo "Advanced tools: protection health, speed/TTFB, DNS evidence, MTU probe, route tester, Last Known Good, recent destinations, support bundle and Emergency Stop."
